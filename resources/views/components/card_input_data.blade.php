            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="input-keluhan" class="form-control" placeholder="" name="pasien_keluhan">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="form-control-label" for="input-riwayat-penyakit">Riwayat Penyakit Sekarang</label>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="input-anemia" class="form-control" placeholder="" name="pasien_anemia">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="form-control-label" for="input-ikterus">Ikterus</label>
                        <input type="text" id="input-ikterus" class="form-control" placeholder="" name="pasien_ikterus">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="input-tonsil" class="form-control" placeholder="" name="pasien_tonsil">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="form-control-label" for="input-faring">Faring</label>
                        <input type="text" id="input-faring" class="form-control" placeholder="" name="pasien_faring">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="checkbox" id="input-edema" class="form-control" placeholder="" name="pasien_edema">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group">
